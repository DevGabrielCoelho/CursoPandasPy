...
print(series)
print(pd.to_datetime(series.index).month)
print(pd.to_datetime(series.index).year)
print(series.loc[pd.to_datetime(series.index).month == 7].sum())
print(series.loc[pd.to_datetime(series.index).year == 1950].sum())
